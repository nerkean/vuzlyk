  ...
  var require_main = __commonJS({
    "public/js/main.js"() {
      ...
      function formatPriceJS(amountUAH, targetCurrency, rates, symbols) {
        ...
        const currency = targetCurrency && rates[targetCurrency] && symbols[targetCurrency] ? targetCurrency : "UAH";
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        try {
          const heroSwiperElement2 = document.querySelector(".hero-swiper");
          if (typeof Swiper !== "undefined" && heroSwiperElement2) {
            const heroSwiper = new Swiper(".hero-swiper", {
              loop: true,
              effect: "fade",
              fadeEffect: { crossFade: true },
        ...
        const cartCountElement = document.querySelector(".header-cart .cart-count");
        document.body.addEventListener("click", async (event2) => {
          const addToCartButton = event2.target.closest(".add-to-cart-button, .btn-tertiary[data-product-id]");
          if (!addToCartButton || addToCartButton.disabled) {
            return;
          }
          if (event2.target.closest(".cart-item-quantity") || event2.target.closest(".remove-item-btn")) {
            return;
          }
          event2.preventDefault();
        ...
        if (cartItemsList) {
          ...
          const csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute("content");
          cartItemsList.addEventListener("click", async (event2) => {
        ...
        document.body.addEventListener("click", async (event2) => {
          const wishlistBtn = event2.target.closest(".wishlist-btn");
          const removeFromWishlistBtn = event2.target.closest(".remove-from-wishlist");
        ...
        if (submenuToggle) {
          submenuToggle.addEventListener("click", function(event2) {
