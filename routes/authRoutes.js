...
async function sendVerificationEmail(email, code) {
    ...
    const mailOptions = {
        ...
        to: email,
        subject: 'Код підтвердження реєстрації 🧵 Вузлик до вузлика',
        html: `
        <!DOCTYPE html>
        <html lang="uk">
        <head>
        ...
        <body style="margin: 0; padding: 0; background-color: #F4F2EE; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;">
                ...
                <tr>
                    <td align="center">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.04);">
                            <tr>
                                <td align="center" style="padding: 35px 20px; border-bottom: 1px solid #EAE6DF; background-color: #ffffff;">
                                    <h1 style="margin: 0; color: #111111; font-size: 26px; font-weight: 800; letter-spacing: -0.5px;">
                            ...
                            <tr>
                                <td align="center" style="padding: 40px 30px; background-color: #ffffff;">
                                    <h2 style="margin: 0 0 20px 0; color: #111111; font-size: 22px; font-weight: 600;">Вітаємо у світі естетики!</h2>
                                    <p style="margin: 0 0 30px 0; color: #666666; font-size: 16px; line-height: 1.6;">
                                        Ми раді бачити вас серед поціновувачів ручної вишивки. Щоб завершити створення вашого особистого кабінету, будь ласка, використайте цей код:
                                    </p>
                                    
                                    <div style="background-color: #fdfaf6; border: 2px dashed #e1c8a0; border-radius: 12px; padding: 30px 20px; margin-bottom: 30px;">
                                        <p style="margin: 0; font-size: 36px; font-weight: bold; color: #b9936c; letter-spacing: 10px;">${code}</p>
                                    </div>
                                    
                                    <p style="margin: 0; color: #888888; font-size: 14px; line-height: 1.5;">
                                        Цей код діє протягом <strong>15 хвилин</strong>.<br>
                                        Якщо ви не реєструвалися на нашому сайті, просто проігноруйте цей лист.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" style="padding: 30px; background-color: #faf9f7; border-top: 1px solid #EAE6DF;">
                                    ...
                                    <p style="margin: 0; color: #aaaaaa; font-size: 12px; line-height: 1.4;">
                                        Це автоматичне повідомлення.<br>
                                        Відправлено з адреси: ${process.env.EMAIL_USER}
                                    </p>
                                </td>
                            </tr>
                        </table>
        ...
        `,
        text: `Вітаємо у світі естетики "Вузлик до вузлика"!\n\nЩоб завершити створення вашого особистого кабінету, будь ласка, використайте цей код:\n\n${code}\n\nЦей код діє протягом 15 хвилин.\nЯкщо ви не реєструвалися на нашому сайті, просто проігноруйте цей лист.\n\nЗ теплом та натхненням,\nМайстерня «Вузлик до вузлика»`
    };
...
router.get('/verify-email', csrfProtection, (req, res) => {
